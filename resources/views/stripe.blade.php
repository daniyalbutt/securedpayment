...
<body>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <div type="text" id="cardnumber" name="cardnumber" placeholder="0000-0000-0000-0000" class="form-control" required></div>
                                    ...
                                    <div class="col-md-6 pr-0">
                                        <div id="expiry" name="exp_month" type="text" placeholder="MM" maxlength="2" class="form-control" required></div>
                                    </div>
                                    <div class="col-md-6 pl-0">
                                        <div type="text" id="cvv" name="cvv" placeholder="CVV" maxlength="4" class="form-control" required></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    <script>
        ...
        var elements = stripe.elements({
            fonts: [{
                cssSrc: 'https://fonts.googleapis.com/css2?family=Oswald:wght@400;500&display=swap'
            }]
        });
        var style = {
            base: {
        ...
        [cardNumber, cardExpiry, cardCvc].forEach(element => {
            element.on('change', (event) => {
                if (event.error) {
                    $('.error').removeClass('hide').find('.alert') .text(event.error.message);
                } else {
        ...
        function submit_form(data, status, message){
            var form = document.getElementById('card-form');
