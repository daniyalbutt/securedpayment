...
<body>
    ...
    @if ($data->status == 0)
    <form id="payment-form" action="{{ route('payment.save') }}" method="post" class="mt-4 mb-4 container require-validation">
        @csrf
                    ...
                    <div class="payment-right">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <button class="btn btn-info pl-5 pr-5 form-submit-btn" id="form-submit-btn">Pay Now</button>
