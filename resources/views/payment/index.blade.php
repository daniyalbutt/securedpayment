						...
						<table class="table table-responsive-md">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $value->package }}</td>
									<td>${{ $value->price }}</td>
									<td><span class="badge light badge-info">{{ $value->client->brand->name }}</span> <br> <span class="badge light badge-secondary mt-1">{{ $value->merchants->name }} - {{ $value->merchants->getMerchant() }}</span></td>
